  ...
  return (
    <div className="relative min-h-[220px] rounded-2xl overflow-hidden bg-white border border-[#f0f0f0] flex flex-col">
      ...
      <div className="flex items-center gap-1.5 px-4 py-3 bg-[#fafafa] border-b border-[#f0f0f0] shrink-0">
        ...
        <span className="ml-3 text-[11px] text-[#717171] font-mono">solution.approach</span>
      </div>
            ...
            <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              {data.modules.highlight && (
                <div className="el-card p-8 bg-[#f5f5f5] flex flex-col justify-center gap-3">
                  <p className="text-xs font-medium uppercase tracking-widest text-[#717171]">{data.modules.highlight.label}</p>
