...
const inputCls =
  "w-full border border-[#e5e5e5] rounded-[8px] px-4 py-2.5 text-[15px] bg-white text-black placeholder:text-[#717171] focus:outline-none focus:border-black focus:ring-1 focus:ring-black/20 transition-colors";
...
export function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label className="block text-label text-[#717171] mb-1.5">Inquiry type</label>
