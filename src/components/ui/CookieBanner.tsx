      ...
      >
        ...
        <div className="flex items-start gap-4 flex-1 min-w-0">
          <div className="w-9 h-9 rounded-full bg-[#f5f5f5] flex items-center justify-center shrink-0 mt-0.5">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="9" stroke="#777169" strokeWidth="1.6"/>
              <circle cx="9" cy="10" r="1.2" fill="#777169"/>
              <circle cx="14" cy="8" r="1" fill="#777169"/>
              <circle cx="15" cy="13" r="1.4" fill="#777169"/>
              <circle cx="10" cy="15" r="1" fill="#777169"/>
            </svg>
          </div>
          <div className="min-w-0">
            <p className="text-[13px] font-medium text-black tracking-tight">Cookies &amp; Privacy</p>
            <p className="text-[12px] text-[#777169] leading-relaxed mt-0.5">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="px-4 py-2 text-[12px] font-medium text-[#777169] hover:text-black rounded-full hover:bg-[#f5f5f5] transition-colors tracking-[0.01em]"
          >
            Decline
          </button>
          <button
