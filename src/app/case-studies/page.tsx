...
const caseStudies = [
  ...
  { slug: "smart-collect-transformation", title: "Intelligent collections platform recovering R$1.2B annually", client: "Financial Conglomerate", industry: "Financial Services", summary: "Implemented Nextdue — an AI-driven collections platform that segments, prioritizes and personalizes recovery strategies across 8M+ delinquent accounts.", metrics: [{ label: "Recovery", value: "R$1.2B/yr" }, { label: "Efficiency", value: "+45%" }, { label: "Accounts", value: "8M+" }] },
